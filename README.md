...
Stage 1/6: **0.0.0**, demonstration date **2023-06**.
...
This stage contains 4 independent C#/Rust bindings in horizontal and
vertical layouts, with 16 required directed source-to-target pairs.
